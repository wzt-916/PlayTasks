...
public class primaryMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daily_tasks.add(new Tasks("跑步",10));
        daily_tasks.add(new Tasks("打篮球",10));
        daily_tasks.add(new Tasks("引体向上",10));
        daily_tasks.add(new Tasks("city walk",10));
        daily_tasks.add(new Tasks("带她散步",10));
        daily_tasks.add(new Tasks("羽毛球",10));
        daily_tasks.add(new Tasks("桌球",10));
        daily_tasks.add(new Tasks("乒乓球",10));
        daily_tasks.add(new Tasks("带飞啊菜",10));
        daily_tasks.add(new Tasks("俯卧撑",10));
