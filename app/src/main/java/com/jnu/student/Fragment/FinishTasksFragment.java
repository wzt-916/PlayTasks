...
public class FinishTasksFragment extends Fragment {
    private ArrayList<Tasks> finish_tasks;
    private RecyclerView tasksRecyclerView;
    private FinishTasksFragment.TasksAdapter tasksAdapter;
    public FinishTasksFragment() {
        // Required empty public constructor
    }

    public static FinishTasksFragment newInstance(String param1, String param2) {
        FinishTasksFragment fragment = new FinishTasksFragment();
    ...
    public class TasksAdapter extends RecyclerView.Adapter<FinishTasksFragment.TasksAdapter.ViewHolder> {
        ...
        @Override
        public FinishTasksFragment.TasksAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            // Create a new view, which defines the UI of the list item
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.tasks_row, viewGroup, false);

            return new FinishTasksFragment.TasksAdapter.ViewHolder(view);
        }

        // Replace the contents of a view (invoked by the layout manager)
        @Override
        public void onBindViewHolder(FinishTasksFragment.TasksAdapter.ViewHolder viewHolder, final int position) {
